...
public class BeginnersgiftsguiGui extends SiongsngsFantasyWorldModElements.ModElement {
	public static HashMap guistate = new HashMap();
	private static ContainerType<GuiContainerMod> containerType = null;
	public BeginnersgiftsguiGui(SiongsngsFantasyWorldModElements instance) {
		super(instance, 199);
	...
	private static class ContainerRegisterHandler {
		...
		public void registerContainer(RegistryEvent.Register<ContainerType<?>> event) {
			event.getRegistry().register(containerType.setRegistryName("beginnersgiftsgui"));
		}
	}
	@OnlyIn(Dist.CLIENT)
	...
	public static class GuiWindow extends ContainerScreen<GuiContainerMod> {
		...
		private static final ResourceLocation texture = new ResourceLocation("siongsngs_fantasy_world:textures/beginnersgiftsgui.png");
		@Override
		...
		protected void drawGuiContainerForegroundLayer(MatrixStack ms, int mouseX, int mouseY) {
			this.font.drawString(ms, "\u521D\u5B78\u8005\u79AE\u7269(\u95DC\u9589\u4ECB\u9762\u5F8C\u5373\u53EF\u7372\u5F97\u7269\u54C1)", 4, 4,
					-65536);
		}
