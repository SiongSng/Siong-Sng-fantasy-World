...
public class SiongSngBookguiGui extends SiongsngsFantasyWorldModElements.ModElement {
	...
	public static class GuiWindow extends ContainerScreen<GuiContainerMod> {
		...
		protected void drawGuiContainerForegroundLayer(MatrixStack ms, int mouseX, int mouseY) {
			this.font.drawString(ms, "\u83D8\u83D8\u7684\u5E7B\u60F3\u4E16\u754C \u8FAD\u5178-\u77E5\u8B58\u4E4B\u66F8", 5, 6, -12829636);
			this.font.drawString(ms, "\u89E3\u9396\u5167\u5BB9 " + (entity.getPersistentData().getDouble("The_completion_rate")) + " %", 4, 176,
					-12829636);
			this.font.drawString(ms, "www  \u5716\u793A\u9084\u6C92\u88FD\u4F5C\u597D\u5566xd", 10, 92, -12829636);
		}
		...
		public void init(Minecraft minecraft, int width, int height) {
			...
			this.addButton(new Button(this.guiLeft + 212, this.guiTop + 12, 41, 20, new StringTextComponent("進度"), e -> {
