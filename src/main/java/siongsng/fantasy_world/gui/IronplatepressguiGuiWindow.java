...
@OnlyIn(Dist.CLIENT)
public class IronplatepressguiGuiWindow extends ContainerScreen<IronplatepressguiGui.GuiContainerMod> {
	private World world;
	private int x, y, z;
	private PlayerEntity entity;
	public IronplatepressguiGuiWindow(IronplatepressguiGui.GuiContainerMod container, PlayerInventory inventory, ITextComponent text) {
	...
	public void init(Minecraft minecraft, int width, int height) {
		...
		this.addButton(new Button(this.guiLeft + 51, this.guiTop + 56, 57, 20, new StringTextComponent("»s§@"), e -> {
			if (true) {
				SiongsngsFantasyWorldMod.PACKET_HANDLER.sendToServer(new IronplatepressguiGui.ButtonPressedMessage(0, x, y, z));
				IronplatepressguiGui.handleButtonAction(entity, 0, x, y, z);
			}
		}));
	}
}
