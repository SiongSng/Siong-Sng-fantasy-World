...
@OnlyIn(Dist.CLIENT)
public class IronjuicerguiGuiWindow extends ContainerScreen<IronjuicerguiGui.GuiContainerMod> {
	private World world;
	private int x, y, z;
	private PlayerEntity entity;
	public IronjuicerguiGuiWindow(IronjuicerguiGui.GuiContainerMod container, PlayerInventory inventory, ITextComponent text) {
	...
	public void init(Minecraft minecraft, int width, int height) {
		...
		this.addButton(new Button(this.guiLeft + 54, this.guiTop + 59, 41, 20, new StringTextComponent("»s§@"), e -> {
			if (true) {
				SiongsngsFantasyWorldMod.PACKET_HANDLER.sendToServer(new IronjuicerguiGui.ButtonPressedMessage(0, x, y, z));
				IronjuicerguiGui.handleButtonAction(entity, 0, x, y, z);
			}
		}));
	}
}
