...
public class SilverPickaxeItem extends SiongsngsFantasyWorldModElements.ModElement {
	@ObjectHolder("siongsngs_fantasy_world:silver_pickaxe")
	public static final Item block = null;
	public SilverPickaxeItem(SiongsngsFantasyWorldModElements instance) {
		super(instance, 140);
	}
