...
public class RedparticleParticle extends SiongsngsFantasyWorldModElements.ModElement {
	public static final BasicParticleType particle = new BasicParticleType(false);
	public RedparticleParticle(SiongsngsFantasyWorldModElements instance) {
		super(instance, 176);
	...
	public void registerParticleType(RegistryEvent.Register<ParticleType<?>> event) {
		event.getRegistry().register(particle.setRegistryName("redparticle"));
	}
