...
package siongsng.fantasy_world.particle;
...
public class OrangeparticlesParticle extends SiongsngsFantasyWorldModElements.ModElement {
	public static final BasicParticleType particle = new BasicParticleType(false);
	public OrangeparticlesParticle(SiongsngsFantasyWorldModElements instance) {
		super(instance, 223);
	...
	public void registerParticleType(RegistryEvent.Register<ParticleType<?>> event) {
		event.getRegistry().register(particle.setRegistryName("orangeparticles"));
	}
