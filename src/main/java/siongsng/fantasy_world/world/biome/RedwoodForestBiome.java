...
import siongsng.fantasy_world.block.RedwoodLogBlock;
...
public class RedwoodForestBiome extends SiongsngsFantasyWorldModElements.ModElement {
	public static Biome biome;
	public RedwoodForestBiome(SiongsngsFantasyWorldModElements instance) {
		super(instance, 176);
	...
	private static class BiomeRegisterHandler {
		...
		public void registerBiomes(RegistryEvent.Register<Biome> event) {
			if (biome == null) {
				BiomeAmbience effects = new BiomeAmbience.Builder().setFogColor(-59353).setWaterColor(-50109).setWaterFogColor(329011)
						.withSkyColor(-59353).withFoliageColor(-52692).withGrassColor(-59353)
						.setParticle(new ParticleEffectAmbience(RedparticleParticle.particle, 0.005f)).build();
				...
				biomeGenerationSettings.withFeature(GenerationStage.Decoration.VEGETAL_DECORATION, Feature.TREE
						.withConfiguration((new BaseTreeFeatureConfig.Builder(new SimpleBlockStateProvider(RedwoodLogBlock.block.getDefaultState()),
								new SimpleBlockStateProvider(RedwoodLeavesBlock.block.getDefaultState()),
				...
				event.getRegistry().register(biome.setRegistryName("siongsngs_fantasy_world:redwood_forest"));
			}
		}
	}
	@Override
	...
	private static class CustomLeaveVineTreeDecorator extends LeaveVineTreeDecorator {
		...
		static {
			...
			tdt.setRegistryName("redwood_forest_lvtd");
	...
	private static class CustomTrunkVineTreeDecorator extends TrunkVineTreeDecorator {
		...
		static {
			codec = com.mojang.serialization.Codec.unit(() -> instance);
			tdt = new TreeDecoratorType(codec);
			tdt.setRegistryName("redwood_forest_tvtd");
			ForgeRegistries.TREE_DECORATOR_TYPES.register(tdt);
		}
		@Override
		protected TreeDecoratorType<?> func_230380_a_() {
	...
	private static class CustomCocoaTreeDecorator extends CocoaTreeDecorator {
		...
		static {
			codec = com.mojang.serialization.Codec.unit(() -> instance);
			tdt = new TreeDecoratorType(codec);
			tdt.setRegistryName("redwood_forest_ctd");
			ForgeRegistries.TREE_DECORATOR_TYPES.register(tdt);
		}
