...
import siongsng.fantasy_world.block.FantaLogBlock;
import siongsng.fantasy_world.block.FantaLeavesBlock;
import siongsng.fantasy_world.block.FantaFruitBlock;
...
public class FantaLogforestBiome extends SiongsngsFantasyWorldModElements.ModElement {
	public static Biome biome;
	public FantaLogforestBiome(SiongsngsFantasyWorldModElements instance) {
		super(instance, 223);
	...
	private static class BiomeRegisterHandler {
		...
		public void registerBiomes(RegistryEvent.Register<Biome> event) {
			if (biome == null) {
				BiomeAmbience effects = new BiomeAmbience.Builder().setFogColor(-27868).setWaterColor(-30706).setWaterFogColor(-36063)
						.withSkyColor(-27868).withFoliageColor(-33255).withGrassColor(-41472)
						.setParticle(new ParticleEffectAmbience(OrangeparticlesParticle.particle, 0.005f)).build();
				...
				biomeGenerationSettings.withFeature(GenerationStage.Decoration.VEGETAL_DECORATION, Feature.TREE
						.withConfiguration((new BaseTreeFeatureConfig.Builder(new SimpleBlockStateProvider(FantaLogBlock.block.getDefaultState()),
								new SimpleBlockStateProvider(FantaLeavesBlock.block.getDefaultState()),
				...
				event.getRegistry().register(biome.setRegistryName("siongsngs_fantasy_world:fanta_logforest"));
			}
		}
	}
	@Override
	...
	private static class CustomLeaveVineTreeDecorator extends LeaveVineTreeDecorator {
		...
		static {
			...
			tdt.setRegistryName("fanta_logforest_lvtd");
	...
	private static class CustomTrunkVineTreeDecorator extends TrunkVineTreeDecorator {
		...
		static {
			codec = com.mojang.serialization.Codec.unit(() -> instance);
			tdt = new TreeDecoratorType(codec);
			tdt.setRegistryName("fanta_logforest_tvtd");
			ForgeRegistries.TREE_DECORATOR_TYPES.register(tdt);
		}
		@Override
		protected TreeDecoratorType<?> func_230380_a_() {
	...
	private static class CustomCocoaTreeDecorator extends CocoaTreeDecorator {
		...
		static {
			codec = com.mojang.serialization.Codec.unit(() -> instance);
			tdt = new TreeDecoratorType(codec);
			tdt.setRegistryName("fanta_logforest_ctd");
			ForgeRegistries.TREE_DECORATOR_TYPES.register(tdt);
		}
					...
					for (Direction direction : Direction.Plane.HORIZONTAL) {
						if (p_225576_2_.nextFloat() <= 0.25F) {
							...
							if (Feature.isAirAt(p_225576_1_, blockpos)) {
								BlockState blockstate = FantaFruitBlock.block.getDefaultState();
