...
public class SiongforestEcologicaldomainBiome extends SiongsngsFantasyWorldModElements.ModElement {
	public static Biome biome;
	public SiongforestEcologicaldomainBiome(SiongsngsFantasyWorldModElements instance) {
		super(instance, 53);
	...
	private static class BiomeRegisterHandler {
		...
		public void registerBiomes(RegistryEvent.Register<Biome> event) {
			if (biome == null) {
				...
				event.getRegistry().register(biome.setRegistryName("siongsngs_fantasy_world:siongforest_ecologicaldomain"));
			}
		}
	}
	@Override
	public void init(FMLCommonSetupEvent event) {
		BiomeManager.addBiome(BiomeManager.BiomeType.WARM,
				new BiomeManager.BiomeEntry(RegistryKey.getOrCreateKey(Registry.BIOME_KEY, WorldGenRegistries.BIOME.getKey(biome)), 13));
	}
	private static class CustomLeaveVineTreeDecorator extends LeaveVineTreeDecorator {
		...
		static {
			...
			tdt.setRegistryName("siongforest_ecologicaldomain_lvtd");
	...
	private static class CustomTrunkVineTreeDecorator extends TrunkVineTreeDecorator {
		...
		static {
			codec = com.mojang.serialization.Codec.unit(() -> instance);
			tdt = new TreeDecoratorType(codec);
			tdt.setRegistryName("siongforest_ecologicaldomain_tvtd");
			ForgeRegistries.TREE_DECORATOR_TYPES.register(tdt);
		}
		@Override
		protected TreeDecoratorType<?> func_230380_a_() {
	...
	private static class CustomCocoaTreeDecorator extends CocoaTreeDecorator {
		...
		static {
			codec = com.mojang.serialization.Codec.unit(() -> instance);
			tdt = new TreeDecoratorType(codec);
			tdt.setRegistryName("siongforest_ecologicaldomain_ctd");
			ForgeRegistries.TREE_DECORATOR_TYPES.register(tdt);
		}
					...
					for (Direction direction : Direction.Plane.HORIZONTAL) {
						if (p_225576_2_.nextFloat() <= 0.25F) {
							...
							if (Feature.isAirAt(p_225576_1_, blockpos)) {
								BlockState blockstate = SiongfruitBlock.block.getDefaultState();
