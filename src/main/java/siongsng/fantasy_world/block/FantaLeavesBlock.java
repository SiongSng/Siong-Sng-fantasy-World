...
public class FantaLeavesBlock extends SiongsngsFantasyWorldModElements.ModElement {
	@ObjectHolder("siongsngs_fantasy_world:fanta_leaves")
	public static final Block block = null;
	public FantaLeavesBlock(SiongsngsFantasyWorldModElements instance) {
		super(instance, 207);
	}
