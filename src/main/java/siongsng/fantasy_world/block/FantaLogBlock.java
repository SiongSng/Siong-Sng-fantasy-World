...
public class FantaLogBlock extends SiongsngsFantasyWorldModElements.ModElement {
	@ObjectHolder("siongsngs_fantasy_world:fanta_log")
	public static final Block block = null;
	public FantaLogBlock(SiongsngsFantasyWorldModElements instance) {
		super(instance, 205);
	}
