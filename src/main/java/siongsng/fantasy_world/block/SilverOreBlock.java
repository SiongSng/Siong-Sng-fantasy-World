...
public class SilverOreBlock extends SiongsngsFantasyWorldModElements.ModElement {
	@ObjectHolder("siongsngs_fantasy_world:silver_ore")
	public static final Block block = null;
	public SilverOreBlock(SiongsngsFantasyWorldModElements instance) {
		super(instance, 133);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("siongsngs_fantasy_world:silver_ore_match"),
			...
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("siongsngs_fantasy_world:silver_ore"), configuredFeature);
		}
	}
	@SubscribeEvent
