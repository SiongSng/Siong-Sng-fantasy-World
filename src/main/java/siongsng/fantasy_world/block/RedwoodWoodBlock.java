...
public class RedwoodWoodBlock extends SiongsngsFantasyWorldModElements.ModElement {
	@ObjectHolder("siongsngs_fantasy_world:redwood_wood")
	public static final Block block = null;
	public RedwoodWoodBlock(SiongsngsFantasyWorldModElements instance) {
		super(instance, 160);
	}
