...
public class SiongfruitBlock extends SiongsngsFantasyWorldModElements.ModElement {
	@ObjectHolder("siongsngs_fantasy_world:siongfruit")
	public static final Block block = null;
	public SiongfruitBlock(SiongsngsFantasyWorldModElements instance) {
		super(instance, 53);
	}
