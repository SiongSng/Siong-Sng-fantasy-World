...
public class RedwoodLogBlock extends SiongsngsFantasyWorldModElements.ModElement {
	@ObjectHolder("siongsngs_fantasy_world:redwood_log")
	public static final Block block = null;
	public RedwoodLogBlock(SiongsngsFantasyWorldModElements instance) {
		super(instance, 161);
	}
