...
public class RedwoodStairsBlock extends SiongsngsFantasyWorldModElements.ModElement {
	@ObjectHolder("siongsngs_fantasy_world:redwood_stairs")
	public static final Block block = null;
	public RedwoodStairsBlock(SiongsngsFantasyWorldModElements instance) {
		super(instance, 164);
	}
