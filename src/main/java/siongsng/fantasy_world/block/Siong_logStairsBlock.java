...
public class Siong_logStairsBlock extends SiongsngsFantasyWorldModElements.ModElement {
	@ObjectHolder("siongsngs_fantasy_world:siong_log_stairs")
	public static final Block block = null;
	public Siong_logStairsBlock(SiongsngsFantasyWorldModElements instance) {
		super(instance, 61);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("siong_log_stairs");
		}
