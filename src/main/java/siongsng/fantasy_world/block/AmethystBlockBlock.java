...
public class AmethystBlockBlock extends SiongsngsFantasyWorldModElements.ModElement {
	@ObjectHolder("siongsngs_fantasy_world:amethyst_block")
	public static final Block block = null;
	public AmethystBlockBlock(SiongsngsFantasyWorldModElements instance) {
		super(instance, 49);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			super(Block.Properties.create(Material.ROCK).sound(SoundType.STONE).hardnessAndResistance(2f, 12f).setLightLevel(s -> 0).harvestLevel(2)
