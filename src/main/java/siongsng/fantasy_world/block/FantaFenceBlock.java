...
public class FantaFenceBlock extends SiongsngsFantasyWorldModElements.ModElement {
	@ObjectHolder("siongsngs_fantasy_world:fanta_fence")
	public static final Block block = null;
	public FantaFenceBlock(SiongsngsFantasyWorldModElements instance) {
		super(instance, 210);
	}
