...
public class Siong_logPlanksBlock extends SiongsngsFantasyWorldModElements.ModElement {
	@ObjectHolder("siongsngs_fantasy_world:siong_log_planks")
	public static final Block block = null;
	public Siong_logPlanksBlock(SiongsngsFantasyWorldModElements instance) {
		super(instance, 59);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("siong_log_planks");
		}
