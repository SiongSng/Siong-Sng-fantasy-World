...
public class FantaSlabBlock extends SiongsngsFantasyWorldModElements.ModElement {
	@ObjectHolder("siongsngs_fantasy_world:fanta_slab")
	public static final Block block = null;
	public FantaSlabBlock(SiongsngsFantasyWorldModElements instance) {
		super(instance, 209);
	}
