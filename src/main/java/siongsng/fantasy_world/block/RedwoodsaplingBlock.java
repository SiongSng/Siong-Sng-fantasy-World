...
public class RedwoodsaplingBlock extends SiongsngsFantasyWorldModElements.ModElement {
	@ObjectHolder("siongsngs_fantasy_world:redwoodsapling")
	public static final Block block = null;
	@ObjectHolder("siongsngs_fantasy_world:redwoodsapling")
	public static final TileEntityType<CustomTileEntity> tileEntityType = null;
	public RedwoodsaplingBlock(SiongsngsFantasyWorldModElements instance) {
		super(instance, 177);
	...
	private static class TileEntityRegisterHandler {
		...
		public void registerTileEntity(RegistryEvent.Register<TileEntityType<?>> event) {
			event.getRegistry().register(TileEntityType.Builder.create(CustomTileEntity::new, block).build(null).setRegistryName("redwoodsapling"));
		}
	}
	@Override
	@OnlyIn(Dist.CLIENT)
		...
		public void animateTick(BlockState state, World world, BlockPos pos, Random random) {
			...
			if (true)
				for (int l = 0; l < 2; ++l) {
					...
					world.addParticle(RedparticleParticle.particle, d0, d1, d2, d3, d4, d5);
				}
		}
	...
	public static class CustomTileEntity extends LockableLootTileEntity implements ISidedInventory {
		...
		public ITextComponent getDefaultName() {
			return new StringTextComponent("redwoodsapling");
		}
		...
		public ITextComponent getDisplayName() {
			return new StringTextComponent("Redwood Log Sapling(block)");
		}
