...
public class RedwoodPlanksBlock extends SiongsngsFantasyWorldModElements.ModElement {
	@ObjectHolder("siongsngs_fantasy_world:redwood_planks")
	public static final Block block = null;
	public RedwoodPlanksBlock(SiongsngsFantasyWorldModElements instance) {
		super(instance, 162);
	}
