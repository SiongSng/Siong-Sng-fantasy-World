...
public class SiongSaplingBlock extends SiongsngsFantasyWorldModElements.ModElement {
	@ObjectHolder("siongsngs_fantasy_world:siong_sapling")
	public static final Block block = null;
	@ObjectHolder("siongsngs_fantasy_world:siong_sapling")
	public static final TileEntityType<CustomTileEntity> tileEntityType = null;
	public SiongSaplingBlock(SiongsngsFantasyWorldModElements instance) {
		super(instance, 91);
	...
	private static class TileEntityRegisterHandler {
		...
		public void registerTileEntity(RegistryEvent.Register<TileEntityType<?>> event) {
			event.getRegistry().register(TileEntityType.Builder.create(CustomTileEntity::new, block).build(null).setRegistryName("siong_sapling"));
		}
	}
	@Override
	@OnlyIn(Dist.CLIENT)
	...
	public static class CustomBlock extends Block {
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(SiongSaplingitemItem.block, (int) (1)));
		}
	...
	public static class CustomTileEntity extends LockableLootTileEntity implements ISidedInventory {
		...
		public ITextComponent getDefaultName() {
			return new StringTextComponent("siong_sapling");
		}
