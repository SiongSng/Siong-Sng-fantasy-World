...
public class SilverBlockBlock extends SiongsngsFantasyWorldModElements.ModElement {
	@ObjectHolder("siongsngs_fantasy_world:silver_block")
	public static final Block block = null;
	public SilverBlockBlock(SiongsngsFantasyWorldModElements instance) {
		super(instance, 134);
	}
