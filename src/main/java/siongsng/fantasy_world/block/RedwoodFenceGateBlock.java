...
public class RedwoodFenceGateBlock extends SiongsngsFantasyWorldModElements.ModElement {
	@ObjectHolder("siongsngs_fantasy_world:redwood_fence_gate")
	public static final Block block = null;
	public RedwoodFenceGateBlock(SiongsngsFantasyWorldModElements instance) {
		super(instance, 167);
	}
