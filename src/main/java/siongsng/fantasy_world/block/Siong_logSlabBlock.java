...
public class Siong_logSlabBlock extends SiongsngsFantasyWorldModElements.ModElement {
	@ObjectHolder("siongsngs_fantasy_world:siong_log_slab")
	public static final Block block = null;
	public Siong_logSlabBlock(SiongsngsFantasyWorldModElements instance) {
		super(instance, 62);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("siong_log_slab");
		}
