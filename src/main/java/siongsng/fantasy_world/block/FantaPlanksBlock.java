...
public class FantaPlanksBlock extends SiongsngsFantasyWorldModElements.ModElement {
	@ObjectHolder("siongsngs_fantasy_world:fanta_planks")
	public static final Block block = null;
	public FantaPlanksBlock(SiongsngsFantasyWorldModElements instance) {
		super(instance, 206);
	}
