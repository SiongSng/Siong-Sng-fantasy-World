...
public class Siong_logLogBlock extends SiongsngsFantasyWorldModElements.ModElement {
	@ObjectHolder("siongsngs_fantasy_world:siong_log_log")
	public static final Block block = null;
	public Siong_logLogBlock(SiongsngsFantasyWorldModElements instance) {
		super(instance, 58);
	}
