...
public class FantaStairsBlock extends SiongsngsFantasyWorldModElements.ModElement {
	@ObjectHolder("siongsngs_fantasy_world:fanta_stairs")
	public static final Block block = null;
	public FantaStairsBlock(SiongsngsFantasyWorldModElements instance) {
		super(instance, 208);
	}
