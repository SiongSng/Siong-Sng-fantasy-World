...
public class Siong_logWoodBlock extends SiongsngsFantasyWorldModElements.ModElement {
	@ObjectHolder("siongsngs_fantasy_world:siong_log_wood")
	public static final Block block = null;
	public Siong_logWoodBlock(SiongsngsFantasyWorldModElements instance) {
		super(instance, 57);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("siong_log_wood");
		}
