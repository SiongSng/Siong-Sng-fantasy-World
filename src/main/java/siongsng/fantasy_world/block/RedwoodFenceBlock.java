...
public class RedwoodFenceBlock extends SiongsngsFantasyWorldModElements.ModElement {
	@ObjectHolder("siongsngs_fantasy_world:redwood_fence")
	public static final Block block = null;
	public RedwoodFenceBlock(SiongsngsFantasyWorldModElements instance) {
		super(instance, 166);
	}
