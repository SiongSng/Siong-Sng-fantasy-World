...
public class FantasaplingBlock extends SiongsngsFantasyWorldModElements.ModElement {
	@ObjectHolder("siongsngs_fantasy_world:fantasapling")
	public static final Block block = null;
	@ObjectHolder("siongsngs_fantasy_world:fantasapling")
	public static final TileEntityType<CustomTileEntity> tileEntityType = null;
	public FantasaplingBlock(SiongsngsFantasyWorldModElements instance) {
		super(instance, 220);
	...
	private static class TileEntityRegisterHandler {
		...
		public void registerTileEntity(RegistryEvent.Register<TileEntityType<?>> event) {
			event.getRegistry().register(TileEntityType.Builder.create(CustomTileEntity::new, block).build(null).setRegistryName("fantasapling"));
		}
	}
	@Override
	@OnlyIn(Dist.CLIENT)
	...
	public static class CustomBlock extends Block {
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(FantasaplingitemItem.block, (int) (1)));
		}
	...
	public static class CustomTileEntity extends LockableLootTileEntity implements ISidedInventory {
		...
		public ITextComponent getDefaultName() {
			return new StringTextComponent("fantasapling");
		}
		...
		public ITextComponent getDisplayName() {
			return new StringTextComponent("Fanta Log Sapling(block)");
		}
