...
public class Siong_logFenceGateBlock extends SiongsngsFantasyWorldModElements.ModElement {
	@ObjectHolder("siongsngs_fantasy_world:siong_log_fence_gate")
	public static final Block block = null;
	public Siong_logFenceGateBlock(SiongsngsFantasyWorldModElements instance) {
		super(instance, 64);
	}
	...
	public static class CustomBlock extends FenceGateBlock {
		public CustomBlock() {
			...
			setRegistryName("siong_log_fence_gate");
		}
