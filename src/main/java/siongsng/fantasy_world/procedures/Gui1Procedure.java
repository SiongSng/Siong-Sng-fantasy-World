...
public class Gui1Procedure extends SiongsngsFantasyWorldModElements.ModElement {
	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		...
		if ((((new Object() {
			public ItemStack getItemStack(BlockPos pos, int sltid) {
		...
		}.getItemStack(new BlockPos((int) x, (int) y, (int) z), (int) (1))).getItem() == new ItemStack(CopperingotItem.block, (int) (1)).getItem())
				&& (((new Object() {
				...
				}.getItemStack(new BlockPos((int) x, (int) y, (int) z), (int) (1)))).getCount()) >= 2)))) {
			if (!world.isRemote()) {
				BlockPos _bp = new BlockPos((int) x, (int) y, (int) z);
				TileEntity _tileEntity = world.getTileEntity(_bp);
				BlockState _bs = world.getBlockState(_bp);
				...
				private void run() {
					{
						...
						if (_ent != null) {
							...
							final ItemStack _setstack = new ItemStack(CopperplateItem.block, (int) (1));
							...
							}.getItemStack(new BlockPos((int) x, (int) y, (int) z), (int) (2)))).getCount()) + 1));
							_ent.getCapability(CapabilityItemHandler.ITEM_HANDLER_CAPABILITY, null).ifPresent(capability -> {
								if (capability instanceof IItemHandlerModifiable) {
					...
					if ((Math.random() < 0.3)) {
						{
							...
							if (_ent != null) {
								...
								final ItemStack _setstack = new ItemStack(CopperparticleItem.block, (int) (1));
								_setstack.setCount((int) ((((new Object() {
									public ItemStack getItemStack(BlockPos pos, int sltid) {
										AtomicReference<ItemStack> _retval = new AtomicReference<>(ItemStack.EMPTY);
										TileEntity _ent = world.getTileEntity(pos);
								...
								}.getItemStack(new BlockPos((int) x, (int) y, (int) z), (int) (3)))).getCount()) + 1));
								_ent.getCapability(CapabilityItemHandler.ITEM_HANDLER_CAPABILITY, null).ifPresent(capability -> {
									if (capability instanceof IItemHandlerModifiable) {
										((IItemHandlerModifiable) capability).setStackInSlot(_sltid, _setstack);
									}
		...
		}.getItemStack(new BlockPos((int) x, (int) y, (int) z), (int) (1))).getItem() == new ItemStack(AmethystingotItem.block, (int) (1)).getItem())
				&& (((new Object() {
					public boolean getValue(IWorld world, BlockPos pos, String tag) {
						TileEntity tileEntity = world.getTileEntity(pos);
						if (tileEntity != null)
				...
				private void run() {
					{
						...
						if (_ent != null) {
							final int _sltid = (int) (2);
							final ItemStack _setstack = new ItemStack(AmethystplateItem.block, (int) (1));
							_setstack.setCount((int) ((((new Object() {
								public ItemStack getItemStack(BlockPos pos, int sltid) {
									AtomicReference<ItemStack> _retval = new AtomicReference<>(ItemStack.EMPTY);
									TileEntity _ent = world.getTileEntity(pos);
					...
					if ((Math.random() < 0.3)) {
						{
							...
							if (_ent != null) {
								final int _sltid = (int) (3);
								final ItemStack _setstack = new ItemStack(AmethystdustItem.block, (int) (1));
								_setstack.setCount((int) ((((new Object() {
									public ItemStack getItemStack(BlockPos pos, int sltid) {
										AtomicReference<ItemStack> _retval = new AtomicReference<>(ItemStack.EMPTY);
										TileEntity _ent = world.getTileEntity(pos);
