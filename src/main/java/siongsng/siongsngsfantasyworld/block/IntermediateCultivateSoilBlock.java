...
public class IntermediateCultivateSoilBlock extends SiongsngsFantasyWorldModElements.ModElement {
	@ObjectHolder("siongsngs_fantasy_world:intermediate_cultivate_soil")
	public static final Block block = null;
	public IntermediateCultivateSoilBlock(SiongsngsFantasyWorldModElements instance) {
		super(instance, 38);
	}
