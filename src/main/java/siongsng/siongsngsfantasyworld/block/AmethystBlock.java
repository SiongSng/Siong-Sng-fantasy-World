...
public class AmethystBlock extends SiongsngsFantasyWorldModElements.ModElement {
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			super(Block.Properties.create(Material.IRON).sound(SoundType.GLASS).hardnessAndResistance(3f, 20f).setLightLevel(s -> 2)
		...
		public void addInformation(ItemStack itemstack, IBlockReader world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("\u00A7b\u91D1\u5149\u9583\u9583\uFF0C\u795E\u79D8\u7684\u7D2B\u6C34\u6676"));
		}
	...
	public void addFeatureToBiomes(BiomeLoadingEvent event) {
		...
		}, block.getDefaultState(), 2)).range(95).square().func_242731_b(15));
	}
}
