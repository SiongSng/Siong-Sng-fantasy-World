...
package siongsng.siongsngsfantasyworld.gui;
...
public class CopperbackpackguiGui extends SiongsngsFantasyWorldModElements.ModElement {
	public static HashMap guistate = new HashMap();
	private static ContainerType<GuiContainerMod> containerType = null;
	public CopperbackpackguiGui(SiongsngsFantasyWorldModElements instance) {
		super(instance, 41);
	...
	public void registerContainer(RegistryEvent.Register<ContainerType<?>> event) {
		event.getRegistry().register(containerType.setRegistryName("copperbackpackgui"));
	}
	...
	public static class GuiContainerMod extends Container implements Supplier<Map<Integer, Slot>> {
		...
		public GuiContainerMod(int id, PlayerInventory inv, PacketBuffer extraData) {
			...
			this.customSlots.put(27, this.addSlot(new SlotItemHandler(internal, 27, 7, 75) {
			}));
			this.customSlots.put(28, this.addSlot(new SlotItemHandler(internal, 28, 25, 75) {
			}));
			this.customSlots.put(29, this.addSlot(new SlotItemHandler(internal, 29, 43, 75) {
			}));
			this.customSlots.put(30, this.addSlot(new SlotItemHandler(internal, 30, 61, 75) {
			}));
			this.customSlots.put(31, this.addSlot(new SlotItemHandler(internal, 31, 79, 75) {
			}));
			this.customSlots.put(32, this.addSlot(new SlotItemHandler(internal, 32, 97, 75) {
			}));
			this.customSlots.put(33, this.addSlot(new SlotItemHandler(internal, 33, 115, 75) {
			}));
			this.customSlots.put(34, this.addSlot(new SlotItemHandler(internal, 34, 133, 75) {
			}));
			this.customSlots.put(35, this.addSlot(new SlotItemHandler(internal, 35, 151, 75) {
			}));
			int si;
			int sj;
			for (si = 0; si < 3; ++si)
	...
	public static class GuiWindow extends ContainerScreen<GuiContainerMod> {
		...
		private static final ResourceLocation texture = new ResourceLocation("siongsngs_fantasy_world:textures/copperbackpackgui.png");
		@Override
		...
		protected void drawGuiContainerForegroundLayer(MatrixStack ms, int mouseX, int mouseY) {
			this.font.drawString(ms, "\u9285\u80CC\u5305(9X4)", 5, 4, -3304893);
		}
