...
import siongsng.siongsngsfantasyworld.itemgroup.SiongSngworldUtilitiesItemGroup;
import siongsng.siongsngsfantasyworld.gui.CopperbackpackguiGui;
...
public class CopperbackpackItem extends SiongsngsFantasyWorldModElements.ModElement {
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			super(new Item.Properties().group(SiongSngworldUtilitiesItemGroup.tab).maxStackSize(1).rarity(Rarity.COMMON));
