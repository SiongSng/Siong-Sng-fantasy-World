...
package siong.sng.fantasy_world.block;

import siong.sng.fantasy_world.particle.BlueflameParticle;
import siong.sng.fantasy_world.itemgroup.SiongSngIndustrialcomponentsItemGroup;
import siong.sng.fantasy_world.gui.CooperplatepressguiGui;
...
public class CooperplatepressBlock extends SiongsngsFantasyWorldModElements.ModElement {
	...
	private static class TileEntityRegisterHandler {
		...
		public void registerTileEntity(RegistryEvent.Register<TileEntityType<?>> event) {
			event.getRegistry().register(TileEntityType.Builder.create(CustomTileEntity::new, block).build(null).setRegistryName("cooperplatepress"));
		}
	}
			...
			if (entity instanceof ServerPlayerEntity) {
				NetworkHooks.openGui((ServerPlayerEntity) entity, new INamedContainerProvider() {
					...
					public ITextComponent getDisplayName() {
						return new StringTextComponent("Cooper plate press");
					}
	...
	public static class CustomTileEntity extends LockableLootTileEntity implements ISidedInventory {
		...
		public ITextComponent getDefaultName() {
			return new StringTextComponent("cooperplatepress");
		}
