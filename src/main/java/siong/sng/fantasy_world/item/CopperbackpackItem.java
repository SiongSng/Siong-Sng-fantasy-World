...
package siong.sng.fantasy_world.item;

import siong.sng.fantasy_world.itemgroup.UtilityItemGroup;
import siong.sng.fantasy_world.gui.CopperbackpackguiGui;
...
public class CopperbackpackItem extends SiongsngsFantasyWorldModElements.ModElement {
	@ObjectHolder("siongsngs_fantasy_world:copperbackpack")
	public static final Item block = null;
	public CopperbackpackItem(SiongsngsFantasyWorldModElements instance) {
		super(instance, 39);
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			super(new Item.Properties().group(UtilityItemGroup.tab).maxStackSize(1).rarity(Rarity.UNCOMMON));
			setRegistryName("copperbackpack");
		}
			...
			if (entity instanceof ServerPlayerEntity) {
				NetworkHooks.openGui((ServerPlayerEntity) entity, new INamedContainerProvider() {
					...
					public ITextComponent getDisplayName() {
						return new StringTextComponent("Copper backpack");
					}
					...
					public Container createMenu(int id, PlayerInventory inventory, PlayerEntity player) {
						...
						return new CopperbackpackguiGui.GuiContainerMod(id, inventory, packetBuffer);
					}
				}, buf -> {
