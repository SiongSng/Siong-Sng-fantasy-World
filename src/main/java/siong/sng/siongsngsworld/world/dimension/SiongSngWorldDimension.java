...
package siong.sng.siongsngsworld.world.dimension;

import siong.sng.siongsngsworld.particle.BlueflameParticle;
import siong.sng.siongsngsworld.item.SiongSngWorldItem;
import siong.sng.siongsngsworld.block.SngCultivatesoilBlock;
import siong.sng.siongsngsworld.block.SiongSngPortalframeBlock;
...
public class SiongSngWorldDimension extends SiongsngsFantasyWorldModElements.ModElement {
	@ObjectHolder("siongsngs_fantasy_world:siong_sng_world_portal")
	public static final CustomPortalBlock portal = null;
	public SiongSngWorldDimension(SiongsngsFantasyWorldModElements instance) {
		super(instance, 12);
	...
	public void clientLoad(FMLClientSetupEvent event) {
		...
		DeferredWorkQueue.runLater(() -> {
			try {
				...
				effectsRegistry.put(new ResourceLocation("siongsngs_fantasy_world:siong_sng_world"), customEffect);
			} catch (Exception e) {
				e.printStackTrace();
			}
		});
	...
	public static final TicketType<BlockPos> CUSTOM_PORTAL = TicketType.create("siong_sng_world_portal", Vector3i::compareTo, 300);
	public static class POIRegisterHandler {
		...
		public void registerPointOfInterest(RegistryEvent.Register<PointOfInterestType> event) {
			poi = new PointOfInterestType("siong_sng_world_portal", Sets.newHashSet(ImmutableSet.copyOf(portal.getStateContainer().getValidStates())),
					0, 1).setRegistryName("siong_sng_world_portal");
	...
	public void initElements() {
		...
		elements.items.add(() -> new SiongSngWorldItem().setRegistryName("siong_sng_world"));
	}
	public static class CustomPortalBlock extends NetherPortalBlock {
		public CustomPortalBlock() {
			...
			setRegistryName("siong_sng_world_portal");
		}
			...
			if (!entity.isPassenger() && !entity.isBeingRidden() && entity.isNonBoss() && !entity.world.isRemote && true) {
				if (entity.func_242280_ah()) {
					...
					teleportToDimension(entity, pos,
							RegistryKey.getOrCreateKey(Registry.WORLD_KEY, new ResourceLocation("siongsngs_fantasy_world:siong_sng_world")));
				} else {
					entity.func_242279_ag();
