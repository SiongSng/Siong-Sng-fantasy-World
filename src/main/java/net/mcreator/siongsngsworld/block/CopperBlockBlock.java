...
public class CopperBlockBlock extends SiongsngsWorldModElements.ModElement {
	@ObjectHolder("siongsngs_world:copper_block")
	public static final Block block = null;
	public CopperBlockBlock(SiongsngsWorldModElements instance) {
		super(instance, 13);
	}
