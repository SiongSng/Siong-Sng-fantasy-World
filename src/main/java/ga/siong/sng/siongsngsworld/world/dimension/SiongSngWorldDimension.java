...
public class SiongSngWorldDimension extends SiongsngsWorldModElements.ModElement {
	@ObjectHolder("siongsngs_world:siong_sng_world_portal")
	public static final CustomPortalBlock portal = null;
	public SiongSngWorldDimension(SiongsngsWorldModElements instance) {
		super(instance, 12);
	...
	public void clientLoad(FMLClientSetupEvent event) {
		...
		DeferredWorkQueue.runLater(() -> {
			try {
				...
				effectsRegistry.put(new ResourceLocation("siongsngs_world:siong_sng_world"), customEffect);
			} catch (Exception e) {
				e.printStackTrace();
			}
		});
			...
			if (!entity.isPassenger() && !entity.isBeingRidden() && entity.isNonBoss() && !entity.world.isRemote && true) {
				if (entity.func_242280_ah()) {
					entity.func_242279_ag();
						...
						new ResourceLocation("siongsngs_world:siong_sng_world"))) {
					entity.func_242279_ag();
					teleportToDimension(entity, pos,
							RegistryKey.getOrCreateKey(Registry.WORLD_KEY, new ResourceLocation("siongsngs_world:siong_sng_world")));
				} else {
					entity.func_242279_ag();
