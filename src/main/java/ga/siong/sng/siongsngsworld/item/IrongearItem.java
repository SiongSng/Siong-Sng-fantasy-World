...
import ga.siong.sng.siongsngsworld.itemgroup.SiongSngIndustrialcomponentsItemGroup;
import ga.siong.sng.siongsngsworld.SiongsngsWorldModElements;

@SiongsngsWorldModElements.ModElement.Tag
public class IrongearItem extends SiongsngsWorldModElements.ModElement {
	@ObjectHolder("siongsngs_world:irongear")
	public static final Item block = null;
	public IrongearItem(SiongsngsWorldModElements instance) {
		super(instance, 18);
	}
